...
public class CustomerApiFacade {
    ...
    public ApiResult updateStatus(String customerId, String newStatus, String correlationId) {
        try {
            var updated = service.changeStatus(customerId, CustomerStatus.valueOf(newStatus), correlationId);
