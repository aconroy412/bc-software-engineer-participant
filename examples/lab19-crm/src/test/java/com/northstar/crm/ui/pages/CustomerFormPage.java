...
public class CustomerFormPage {
    ...
    public CustomerFormPage fill(String id, String name, String status) {
        ...
        new Select(driver.findElement(By.cssSelector("[data-testid=status]"))).selectByVisibleText(status);
        return this;
    }
    public void submit() {
    ...
    public String resultText() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-testid=result]"))).getText();
    }
}
